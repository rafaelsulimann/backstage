package com.${{ values.orgName }}.${{ values.name }}.infra.controllerexceptionhandler;
...
import com.${{ values.orgName }}.${{ values.name }}.core.exceptions.ResourceNotFoundException;
