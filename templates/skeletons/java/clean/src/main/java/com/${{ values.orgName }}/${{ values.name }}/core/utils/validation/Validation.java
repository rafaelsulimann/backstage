package com.${{ values.orgName }}.${{ values.name }}.core.utils.validation;
...
import com.${{ values.orgName }}.${{ values.name }}.core.utils.httpresponse.ErroResponse;
import com.${{ values.orgName }}.${{ values.name }}.core.utils.httpresponse.Resultado;
